...
from .disassembler import MIPS16Disassembler

class MIPS16Architecture(Architecture):
    name = 'mips16'
    max_instr_length = 4
    address_size = 4
    default_int_size = 4
    ...
    disassembler = MIPS16Disassembler()
    ...
    def get_instruction_info(self, data, address):
        return self.disassembler.decode(data, address)

    def get_instruction_text(self, data, address):
        return self.disassembler.text(data, address)
